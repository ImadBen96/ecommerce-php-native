					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation"><a href="#condition" aria-controls="condition" role="tab" data-toggle="tab"><?php echo CONDITIONS; ?></a></li>
                                <li role="presentation"><a href="#return_policy" aria-controls="return_policy" role="tab" data-toggle="tab"><?php echo RETURN_POLICY; ?></a></li>
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <p><a href="product.php?id=<?php echo $row['p_id']; ?>"><?php echo ADD_TO_CART; ?></a></p>
                            </div>
                        </div>
                        <?php
                    }
