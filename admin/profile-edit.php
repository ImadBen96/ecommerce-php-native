...
<section class="content-header">
	<div style="float: none;" class="content-header-left">
		<h1 style="width: 100%; text-align: center;">Edit Profile</h1>
	</div>
</section>
								...
								<div class="box-body">
									...
									<div class="form-group">
							            ...
							            <div class="col-sm-6" style="padding-top:6px;">
							                <img style="border-radius: 5px 0px 10px 0px !important;" src="../assets/uploads/<?php echo $photo; ?>" class="existing-photo" width="140">
							            </div>
							        </div>
