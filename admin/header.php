...
<style>
    ...
    .bg-c-blue {
        ...
        background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(6,41,39,1) 31%, rgba(0,212,255,1) 100%);
	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a  href="index.php" class="logo">
				...
				<span class="logo-lg"><strong>SMART</strong> STORE</span>
			</a>
			...
			<nav class="navbar navbar-static-top">
				...
				<span style="float:left;line-height:50px;color:#fff;padding-left:15px;font-size:18px;">Welcome To Admin Panel</span>
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								<li style="background-color: #106da4;" class="user-footer">
									<div>
										<a style="background-color: #106da4;color: #FFF;border-radius: 5px 0px 10px 0px;" href="profile-edit.php" class="btn btn-default btn-flat">Edit Profile</a>
									</div>
									<div>
										<a style="background-color: #106da4;color: #FFF;border-radius: 5px 0px 10px 0px;" href="logout.php" class="btn btn-default btn-flat">Log out</a>
									</div>
								</li>
							</ul>
						</li>
