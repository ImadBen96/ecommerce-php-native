...
<head>
	...
	<link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/css/bootstrap-touch-slider.css">
	<link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/css/animate.min.css">
	<link rel="stylesheet" href="<?php echo BASE_URL; ?>assets/css/tree-menu.css">
			...
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						?>
						<li><i class="fa fa-user"></i> <?php echo LOGGED_IN_AS; ?> <?php echo $_SESSION['customer']['cust_name']; ?></li>
					...
					<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> <?php echo VIEW_CART; ?> (<?php if(CURRENCY_POSITION == 'Before') {echo CURRENCY_SYMBOL;} ?><?php
					...
					?><?php if(CURRENCY_POSITION == 'After') {echo CURRENCY_SYMBOL;} ?>)</a></li>
				</ul>
			</div>
